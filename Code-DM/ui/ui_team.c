...
static void UpdatePlayerClass(void)
{
	...
	case TM_NOCLASS:
		...
		break;
	case TM_INFILTRATOR:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Infiltrator\n" );
		break;
	case TM_SNIPER:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Sniper\n" );
		break;
	case TM_HEAVY:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Heavy\n" );
		break;
	case TM_DEMO:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Demo\n" );
		break;
	case TM_MEDIC:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Medic\n" );
		break;
	case TM_TECH:
		trap_Cmd_ExecuteText( EXEC_APPEND, "cmd class Tech\n" );
		break;
	case TM_BORG:
...
void TeamMain_Cache( void ) 
{
	...
	s_teammain.pClassShaders[TM_SNIPER] = trap_R_RegisterShaderNoMip( "menu/art/pc_sniper.tga" );//PC_SNIPER,//sneaky, snipe only
	s_teammain.pClassShaders[TM_HEAVY] = trap_R_RegisterShaderNoMip( "menu/art/pc_heavy.tga" );//PC_HEAVY,//slow, heavy attack
	s_teammain.pClassShaders[TM_DEMO] = trap_R_RegisterShaderNoMip( "menu/art/pc_demo.tga" );//PC_DEMO,//go boom
	s_teammain.pClassShaders[TM_MEDIC] = trap_R_RegisterShaderNoMip( "menu/art/pc_medic.tga" );//PC_MEDIC,//heal
	s_teammain.pClassShaders[TM_TECH] = trap_R_RegisterShaderNoMip( "menu/art/pc_tech.tga" );//PC_TECH,//operate
	...
	s_teammain.pClassShaders[TM_VIP] = trap_R_RegisterShaderNoMip( "menu/art/pc_vip.tga" );//PC_VIP,//for escorts

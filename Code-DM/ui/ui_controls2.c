...
static bind_t g_bindings[] = 
{
	...
	{"messagemode", 	MNT_SHORTCUT_CHAT,				ID_CHAT,		ANIM_CHAT,		't',			-1,		-1, -1,MNT_SHORTCUT_KEY},
	{"messagemode2", 	MNT_SHORTCUT_CHATTEAM,		ID_CHAT2,		ANIM_CHAT,		-1,				-1,		-1, -1,MNT_SHORTCUT_KEY},
...
static void Controls_UpdateModel( int anim ) 
{
	...
	s_controls.playerViewangles[YAW] = 180 + 10;
	...
	case ANIM_WEAPON4:
		s_controls.playerWeapon = WP_SCAVENGER_RIFLE;
		break;

	case ANIM_WEAPON5:
		s_controls.playerWeapon = WP_STASIS;
		break;
...
//	s_controls_playermdl.generic.callback		= Controls_ModelEvent;
	...
	s_controls_playermdl.generic.x				= 455;
	s_controls_playermdl.generic.y				= 145;
	s_controls_playermdl.width					= 32*5.6;
	s_controls_playermdl.height					= 56*5.6;
...
//	if (!uis.demoversion) // Not in demo mode
	{
